...
MINDONE_SHRINKER_DEFINE(pool_shrinker, dmabuf_page_pool_shrink_count, dmabuf_page_pool_shrink_scan, DEFAULT_SEEKS);

static int dmabuf_page_pool_init_shrinker(void)
{
	return pool_shrinker_register("dmabuf-page-pool-shrinker");
}
