...
struct otg_switch_mtk {
	...
	bool vbus_on;	/* our own enable count for @vbus (regulator_is_enabled() reports the
			 * hardware state, which is "on" from the bootloader while our use_count
			 * is still 0 -> unbalanced regulator_disable() WARN at boot) */
