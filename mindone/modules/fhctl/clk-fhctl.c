...
#include <drivers/clk/mediatek/clk-fhctl.h>
#include <drivers/clk/mediatek/clk-fhctl-util.h>
#include "clk-mtk.h"
...
static void fh_plt_drv_remove(struct platform_device *pdev) {return; }
