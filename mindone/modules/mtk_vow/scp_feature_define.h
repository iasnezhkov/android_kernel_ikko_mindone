...
/* scp_register_sensor/scp_deregister_sensor removed here: scp_rv.h (now included
 * via scp.h once mtk_vow stopped forcing CONFIG_MTK_TINYSYS_SCP_CM4_SUPPORT) already
 * declares both with a compatible (int sensor_id) signature, and neither is called
 * anywhere in this module -- this enum-typed redeclaration just conflicted with
 * scp_rv.hs and had no callers to preserve. */
