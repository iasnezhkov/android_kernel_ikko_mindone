...
/*
 * Total 50min * 60s = 3000s, stepped down over 30 steps, ~110mA per step.
 * One step down every 100s, from 5460 down to 2160.
 * (original vendor comment's encoding was corrupted; reconstructed from
 * the #defines below)
 */
...
#define TEMP_T0_T5_CURR		1080 /*<0 || 55�� 500ma * 9.5v / 4.4v*/
#define TEMP_T0_T1_CURR		3240 /*0 - 15�� 1500ma * 9.5v / 4.4v*/
#define TEMP_T1_T2_CURR		BATT_FAST_CHG_CURR /*15 - 45�� ������*/
#define TEMP_T2_T3_CURR		1800/*45 - 55�� 2500ma * 9.5v / 4.4v*/
// drv add by liuruiqian for temp limit current,20240731 start
