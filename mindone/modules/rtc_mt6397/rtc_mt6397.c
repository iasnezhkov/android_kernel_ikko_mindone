...
#include <linux/rtc.h>
#include "vendor_mt6397_rtc.h"
#include <linux/mod_devicetable.h>
#include <linux/nvmem-provider.h>
#include <linux/sched_clock.h>

#ifdef SUPPORT_EOSC_CALI
#include "vendor_mt6357_registers.h"
#include "vendor_mt6358_registers.h"
#include "vendor_mt6359p_registers.h"
#endif
			...
			void *unused)
{
	...
	dev_dbg(rtc->rtc_dev->dev.parent, "%s = %lu\n", __func__, pm_event);
