...
static int nan_siocdevprivate(struct net_device *dev, struct ifreq *ifr,
				  void __user *data, int cmd)
{
	return nanDoIOCTL(dev, ifr, cmd);
}
#endif
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0)
	.ndo_siocdevprivate = nan_siocdevprivate,
#endif
...
/* allocate netdev */
	...
	dev_addr_set(prNanDev, rRandMacAddr); /* MINDONE-DEVADDR 30.08 (F3118) */
