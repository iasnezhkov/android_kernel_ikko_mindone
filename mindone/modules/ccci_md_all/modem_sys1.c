	...
	struct ap_query_md_feature *ap_feature)
{
	...
	pr_notice("MINDONE-MD-LAYOUT(%s): nc ap=0x%llx md=0x%llx size=0x%x | c ap=0x%llx md=0x%llx size=0x%x | runtime md=0x%llx\n",
		...
		md->mem_layout.md_bank4_noncacheable_total.size,
		(unsigned long long)md->mem_layout.md_bank4_cacheable_total.base_ap_view_phy,
		(unsigned long long)md->mem_layout.md_bank4_cacheable_total.base_md_view_phy,
		md->mem_layout.md_bank4_cacheable_total.size,
		(unsigned long long)ap_feature->ap_runtime_data_addr);
}
