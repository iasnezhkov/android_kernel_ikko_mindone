...
const char *clk_dbg_ver[MAX_CLK_DBG_VERSION] = {
	[CLK_DBG_VER_1] = "v1",
	[CLK_DBG_VER_2] = "v2",
};
...
struct clk_cali_regs clk_dbg_reg[MAX_CLK_DBG_VERSION] = {
	[CLK_DBG_VER_1] = {
...
static unsigned int get_ulposc_clk_by_fmeter_vlp(void)
{
...
static int mt_scp_dts_gpio_check(struct platform_device *pdev)
{
		...
		struct device_node *node)
{
	...
	struct mt6397_chip *chip;	/* was pmic_main_chip: type undefined anywhere; stock mt6397.ko puts mt6397_chip in drvdata, layout confirmed */
...
static struct platform_driver mt_scp_dvfs_pdrv = {
	...
	.remove_new = mt_scp_dvfs_pdrv_remove,
	.driver = {
		.name = "scp_dvfs",
		.owner = THIS_MODULE,
