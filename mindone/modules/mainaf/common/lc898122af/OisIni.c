...
void IniGyr(void)
{
 ...
 /* CmShtOpe[1:0] 00: 僔?僢僞乕OFF, 01: 僔?僢僞乕ON, 1x:奜?惂屼 */
	...
	/* CmLmt3Mod       0: 捠忢?儈僢僞乕摦嶌, 1: 墌偺敿宎?儈僢僞乕摦嶌 */
	...
	RamWrite32A_LC898122AF(
		gylmt4HS0,
		GYRLMT4_S1); /* 0x112B        Y幉Limiter4 High?抣0 */
	RamWrite32A_LC898122AF(
		gxlmt4HS0,
		GYRLMT4_S1); /* 0x102B        X幉Limiter4 High?抣0 */

	RamWrite32A_LC898122AF(
		gxlmt4HS1,
		GYRLMT4_S2); /* 0x102C        X幉Limiter4 High?抣1 */
	RamWrite32A_LC898122AF(
		gylmt4HS1,
		GYRLMT4_S2); /* 0x112C        Y幉Limiter4 High?抣1 */
...
void IniAdj(void)
{
	...
	RegWriteA_LC898122AF(CMSDAC0,
			     BIAS_CUR_OIS); /* 0x0251       Hall Dac揹棳 */
