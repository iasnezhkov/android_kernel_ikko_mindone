...
/*
 * copy data to sspm iomem region (word-aligned)
 * @param trg: target sspm iomem address
 * @param src: source kernel buffer
 * @param size: byte length to copy
 */
...
/*
 * copy data from sspm iomem region (word-aligned)
 * @param trg: target kernel buffer
 * @param src: source sspm iomem address
 * @param size: byte length to copy
 */
