 ...
 * GLOBAL VARIABLE
 *****************************************************************************/
MINDONE_DEFINE_SEMAPHORE(hacc_sem);
MINDONE_DEFINE_SEMAPHORE(mtd_sem);
MINDONE_DEFINE_SEMAPHORE(rid_sem);
MINDONE_DEFINE_SEMAPHORE(sec_mm_sem);
MINDONE_DEFINE_SEMAPHORE(osal_fp_sem);
MINDONE_DEFINE_SEMAPHORE(osal_verify_sem);
MINDONE_DEFINE_SEMAPHORE(osal_secro_sem);
MINDONE_DEFINE_SEMAPHORE(osal_secro_v5_sem);
