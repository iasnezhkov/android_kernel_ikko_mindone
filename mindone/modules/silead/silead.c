...
#include <linux/i2c.h>
#include <mindone/compat.h>	/* MINDONE_I2C_PROBE: .probe vs .probe_new depending on kernel version */
...
/* 6.12: the header moved asm/unaligned.h -> linux/unaligned.h (commit 5f60d5f6bbc1) */
...
/* 6.6+: i2c_driver.probe takes only client (probe_new was merged into probe). We get the
 * second argument via the standard i2c_client_get_device_id() -- it also exists on 6.1.
 * The MINDONE_I2C_PROBE wrapper (include/mindone/compat.h) substitutes .probe or
 * .probe_new depending on kernel version. */
...
static struct i2c_driver silead_ts_driver = {
	MINDONE_I2C_PROBE(silead_ts_probe),
