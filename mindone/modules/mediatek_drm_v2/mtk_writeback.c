			  ...
			  struct mtk_drm_crtc *mtk_crtc)
{
	...
	/* possible_crtcs added upstream (real API addition) -- this
	 * writeback connector is only ever used with its own associated
	 * mtk_crtc, so drm_crtc_mask() on that crtc is the real, correct
