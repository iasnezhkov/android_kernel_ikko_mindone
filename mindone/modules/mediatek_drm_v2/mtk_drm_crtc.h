...
#define MSYNC_MIN_FPS 46.1 /* kept for documentation; kernel code must
 * not do float division (no FPU in this context, and clang correctly
 * rejects %f/double use with this AAPCS target) -- use the fixed-point
 * x10 integer form below for any real arithmetic/printing. */
#define MSYNC_MIN_FPS_X10 461 /* MSYNC_MIN_FPS * 10, exact */
