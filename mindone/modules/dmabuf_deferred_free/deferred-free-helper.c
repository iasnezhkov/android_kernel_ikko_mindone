...
MINDONE_SHRINKER_DEFINE(freelist_shrinker, freelist_shrink_count, freelist_shrink_scan, DEFAULT_SEEKS);
...
static int deferred_freelist_init(void)
{
	...
	return freelist_shrinker_register("dmabuf-deferred-free-shrinker");
}
