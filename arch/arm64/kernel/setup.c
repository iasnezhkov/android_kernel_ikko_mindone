...
void __init __no_sanitize_address setup_arch(char **cmdline_p)
{
	...
	*cmdline_p = boot_command_line;
	...
	early_fixmap_init();
	early_ioremap_init();
	mindone_ringlog_arch_mark(MRL_SETUP_ARCH_ENTRY, 0, 0);

	setup_machine_fdt(__fdt_pointer);
	mindone_ringlog_arch_reserve();
	mindone_ringlog_arch_mark(MRL_FDT_SCANNED, 0, 0);
	...
	paging_init();
	mindone_ringlog_arch_mark(MRL_PAGING_INIT, 0, 0);
	...
	mindone_ringlog_arch_mark(MRL_SETUP_ARCH_EXIT, 0, 0);
