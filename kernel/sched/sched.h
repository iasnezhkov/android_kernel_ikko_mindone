...
/*
 * MINDONE-SCHED-UCLAMP: uclamp_latency_sensitive() as in ACK 5.10 — the
 * out-of-tree scheduler module (fair.c) needs it; the latency_sensitive
 * task_group field and its cgroup file already exist in this 6.1 base.
 * static inline: no export, no vmlinux cost.
 */
#ifdef CONFIG_UCLAMP_TASK_GROUP
...
/* MINDONE-SCHED-RT: task_may_not_preempt() lives in kernel/sched/rt.c;
 * declared here because the out-of-tree scheduler module includes this header. */
